...
const SingleProduct = () => {
const{getSingeleProduct, isSingleLoading, singleProduct}=useProductContext();
// console.log(singleProduct)
 //useparams means id get krne ke liye 
  const {id } =useParams()
  //  console.log(id)
...
<p className="product-data-price">
  MRP: <del><FormatPrice  price={price + 2553000} /> </del> 
</p>
